...
angular.module('auth.service', [])
	...
	.service('Session', ['$localStorage', '$cookies', 'APP_CONSTANTS', 'PROXIMIDADE_SUPORTE_URLS',
		function ($localStorage, $cookies, APP_CONSTANTS, PROXIMIDADE_SUPORTE_URLS) {
			...
			this.destroy = function (all) {
				...
				if (all) {
					...
					$cookies.remove('VAT', { 'domain': PROXIMIDADE_SUPORTE_URLS.domain });
				}
				return this.auth;
			};
