...
.factory('httpInterceptor', ['$q', '$injector', '$timeout', 'PROX_SUPORTE_URLS', function($q, $injector, $timeout, PROX_SUPORTE_URLS){
	return {
		...
		'responseError': function(rejection) {
			...
			if(rejection.data === null && rejection.status == -1){
				...
				$timeout(function() {
					$injector.get('$window').open(PROX_SUPORTE_URLS.unauthenticated, '_self');
				}, 3000);
			}
			return $q.reject(rejection);
		}
