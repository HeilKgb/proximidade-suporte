...
.controller('MainCtrl', ['$scope', '$state', '$window', '$location', 'AuthService', 'AUTH_EVENTS', 'PROX_SUPORTE_URLS',
 'Notify',
 function($scope, $state, $window, $location, AuthService, AUTH_EVENTS, PROX_SUPORTE_URLS, Notify){
	...
	$scope.profile = function (){
		...
		$window.open(PROX_SUPORTE_URLS.profile_url, '_self');
	};

	$scope.administrate = function (){
		$scope.profilePopover.isOpen = false;
		$window.open(PROX_SUPORTE_URLS.admin, '_self');
	};
